<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditUser.aspx.vb" Inherits="Clase0.EditUser" %>
            ...
            <form id="form1" runat="server">
                    <div class="form-group row text-right">
                     ...
                     <div class="form-group row">
                         <div class="col-sm-6">
                            <asp:Button ID="btn_search_user"  class="btn btn-primary" runat="server" Text="Buscar usuario" />
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                         <div class="col-sm-6">
                            <asp:Button ID="btn_update_user"  class="btn btn-primary" runat="server" Text="Modificar usuario" />
                        </div>
                        <div class="col-sm-6">
                            <asp:Label ID="lb_msg_2" runat="server"></asp:Label>
                        </div>
                    </div>
            </form>
        </div>
