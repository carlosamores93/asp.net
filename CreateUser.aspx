<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreateUser.aspx.vb" Inherits="Clase0.CreateUser" %>
            ...
            <form id="form1" runat="server">
                    ...
                    <div class="form-group row  text-right">
                        ...
                        <div class="col-sm-4 text-left">
                            &nbsp;
                <asp:RadioButton ID="RadioButton1" runat="server" GroupName="status" Text="Active" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:RadioButton ID="RadioButton2" runat="server" GroupName="status" Text="Inactive" />
                        </div>
                    </div>
