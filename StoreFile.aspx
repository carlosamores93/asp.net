<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StoreFile.aspx.vb" Inherits="Clase0.StoreFile" %>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="StoreFile">Subir archivo</a>
                      </li>
            ...
            <form id="form1" runat="server">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <asp:RadioButton ID="update_file" runat="server" GroupName="KLK" Text="SOBREESCRIBIR" />
&nbsp;
                        <asp:RadioButton ID="not_update_file" runat="server" GroupName="KLK" Text="No sobreescribir" />
                    ...
                    <br />
                     <div class="form-group row">
                         ...
                         <div class="col-sm-8">
                            <asp:Button ID="store_file"  class="btn btn-primary" runat="server" Text="Subir archivo" />
                        </div>
                        <div class="col-sm-4">
